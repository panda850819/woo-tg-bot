/**
 * Running with NTBA_FIX_319 node index.js 
 */
var TelegramBot = require('node-telegram-bot-api');
var token = '1929321227:AAHgSVSe0as2RcSnU9TlHt32QbcDJKS-hXw';
var bot = new TelegramBot(token, {polling: true});

/* 邏輯是當使用者點了機器人 reply keyboard 會跳出按鈕， */
...
//   bot.sendMessage(msg.chat.id, "和我們一起在 WOO X 交易吧！", {
//       "reply_markup": {
//           "inline_keyboard": [
//               [
//                   {
//                       text: '低至零手續費交易所 - WOO X',
//                       url: 'https://x.woo.org/'
//                   },
//               ],
//           ],
